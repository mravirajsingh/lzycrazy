            ...
            <div className='container px-96 py-24 mx-auto'>
               <div className='px-5'>
                  ...
                  <div className='flex mt-2 items-center justify-between'>
                     ...
                     <span className='flex text-x font-bold text-gray-500 dark:text-white'>
                        <img className='w-8 h-8' src={User} alt='image' />
                        Sneha Saxena
                     </span>
                     <span className='flex'>
                  ...
                  <h5 className='text-3xl mt-3 text-gray-900 dark:text-white'>
                     Chilli
                  </h5>
